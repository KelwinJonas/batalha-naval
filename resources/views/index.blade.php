...
@section('content')
    ...
    <nav id="navbar" class="navbar navbar-dark fixed-top">
        <a class="navbar-brand mx-auto" href="http://ufape.edu.br/" target="_blank"><img src="{{secure_asset('img/ufape.png')}}" alt="" ></a>
        ...
        <div class="video-wrap">
            <div id="video">
                <video id="bgivd" autoplay loop muted playsinline>
                    <source src="{{secure_asset('video/mar.mp4')}}" type="video/mp4">
                </video>
            </div>
        </div>
    </div>
